...
struct thread_data {
    ...
    pthread_mutex_t *mutex;       // 🔒 Mutex da ottenere
    int wait_to_obtain_ms;        // ⏳ Tempo di attesa prima di ottenere il mutex
    int wait_to_release_ms;       // ⏳ Tempo di attesa prima di rilasciare il mutex
